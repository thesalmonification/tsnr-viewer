const abstracts = [
  ...
  {
    title: "Intracranial Atherosclerosis and Thrombectomy: Modifiable Risks and Outcomes in Large Vessel Occlusion Stroke",
    category: "Scientific",
  ...
  {
    title: "Preoperative Enhancing-Tumor Volumetrics Predict Survival in Adult-Type Diffuse Glioma",
    category: "Scientific",
  ...
  {
    title: "Impact of Hospital Setting on the Utilization of Percutaneous versus Open Drainage for Spinal Epidural Abscess",
    category: "Scientific",
  ...
  {
    title: "MRI Radiomics for Survival Prediction in Brain Metastases: A Machine Learning Analysis",
    category: "Scientific",
    author: "Hamza Salim",
    institution: "MD Anderson Cancer Center",
  ...
  {
    title: "Vessel Wall Remodeling Index and Pathologic Plaque Burden as Quantitative Markers to Differentiate Intracranial Arterial Pathologies in High-Resolution Vessel Wall MRI",
    category: "Scientific",
  ...
  {
    title: "Association Between Quantitative Vessel Wall MRI Metrics and Acute Stroke Across Intracranial Vascular Pathologies",
    category: "Scientific",
    author: "Santiago Aristizabal",
    institution: "UTHealth Houston",
  ...
  {
    title: "Spinal Cord Involvement of Toxoplasmosis: A Rare Manifestation",
    category: "Excerpta",
    author: "Sacha Baldeosingh",
    institution: "UTHealth Houston",
  ...
  {
    title: "Multinodular and Vacuolating Neuronal Tumor Presenting with Neuropsychiatric Decompensation in an Adult with Lennox-Gastaut Syndrome",
    category: "Excerpta",
    author: "Bryan Ubanwa",
  ...
  {
    title: "Aberrant Internal Carotid Artery",
    category: "Excerpta",
    author: "Kinsey Lano",
    institution: "Houston Methodist Hospital",
  ...
  {
    title: "Rare Case of IAC Meningioma",
    category: "Excerpta",
    author: "Aman Jaiswal",
    institution: "UTHealth Houston",
  ...
  {
    title: "Pictorial Review of a Surprising Tumor Mimic of the Central Nervous System: Extranodal Rosai-Dorfman Disease",
    category: "Educational",
    author: "Ceylan Altintas Taslicay",
    institution: "UT Southwestern Medical Center",
