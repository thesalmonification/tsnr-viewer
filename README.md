...
1. Copy the entire `abstract-viewer` folder onto a USB drive  
2. Insert the USB drive into the target computer  
3. Open the folder  
4. **Double-click `index.html`**  
5. The abstract viewer opens in your default web browser  

### Option 2: Copy to Local Computer

1. Copy the folder from USB to the desktop  
